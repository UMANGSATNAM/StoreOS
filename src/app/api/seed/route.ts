...
const NICHE_CONFIGS: Record<string, NicheSeedConfig> = {
  ...
  coaching: {
    ...
    categories: [
      { name: 'Board Exam Prep', icon: '📐', color: '#1e40af', sortOrder: 1 },
      { name: 'JEE/NEET', icon: '🔬', color: '#059669', sortOrder: 2 },
      { name: 'Language Classes', icon: '📝', color: '#7c3aed', sortOrder: 3 },
      { name: 'Computer Courses', icon: '💻', color: '#0891b2', sortOrder: 4 },
      { name: 'Skill Development', icon: '🎨', color: '#dc2626', sortOrder: 5 },
    ],
    products: [
      // Board Exam Prep (catIdx: 0)
      { name: '10th Board', price: 5000, costPrice: 1500, sku: 'BRD-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Complete 10th board exam preparation', catIdx: 0 },
      { name: '12th Board', price: 6000, costPrice: 1800, sku: 'BRD-002', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Complete 12th board exam preparation', catIdx: 0 },
      // JEE/NEET (catIdx: 1)
      { name: 'JEE Foundation', price: 15000, costPrice: 5000, sku: 'JEE-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'JEE foundation course for Class 11-12', catIdx: 1 },
      { name: 'JEE Advanced', price: 25000, costPrice: 8000, sku: 'JEE-002', stock: 999, lowStockAlert: 1, unit: 'course', description: 'JEE Advanced intensive preparation', catIdx: 1 },
      { name: 'NEET', price: 25000, costPrice: 8000, sku: 'NEET-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'NEET medical entrance preparation', catIdx: 1 },
      // Language Classes (catIdx: 2)
      { name: 'Spoken English', price: 3000, costPrice: 900, sku: 'LNG-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Spoken English course - 3 months', catIdx: 2 },
      { name: 'French', price: 4000, costPrice: 1200, sku: 'LNG-002', stock: 999, lowStockAlert: 1, unit: 'course', description: 'French language course - beginner level', catIdx: 2 },
      // Computer Courses (catIdx: 3)
      { name: 'Python Course', price: 8000, costPrice: 2500, sku: 'CMP-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Python programming for beginners', catIdx: 3 },
      { name: 'Web Development', price: 12000, costPrice: 4000, sku: 'CMP-002', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Full-stack web development course', catIdx: 3 },
      { name: 'Tally', price: 5000, costPrice: 1500, sku: 'CMP-003', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Tally accounting software course', catIdx: 3 },
      { name: 'Excel Mastery', price: 3000, costPrice: 900, sku: 'CMP-004', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Advanced Excel and data analysis', catIdx: 3 },
      // Skill Development (catIdx: 4)
      { name: 'GST Course', price: 4000, costPrice: 1200, sku: 'SKL-001', stock: 999, lowStockAlert: 1, unit: 'course', description: 'GST filing and compliance course', catIdx: 4 },
      { name: 'Digital Marketing', price: 10000, costPrice: 3500, sku: 'SKL-002', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Digital marketing certification course', catIdx: 4 },
      { name: 'Photography', price: 6000, costPrice: 2000, sku: 'SKL-003', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Professional photography course', catIdx: 4 },
      { name: 'Public Speaking', price: 3000, costPrice: 900, sku: 'SKL-004', stock: 999, lowStockAlert: 1, unit: 'course', description: 'Public speaking and presentation skills', catIdx: 4 },
    ],
    staff: [
    ...
    nicheSpecificSeeds: async (storeId: string) => {
      const studentDefs = [
        { name: 'Arjun Sharma', phone: '9812345678', email: 'arjun.s@gmail.com', course: 'JEE Foundation', batch: 'Morning', status: 'active', feeTotal: 15000, feePaid: 15000 },
        { name: 'Priya Desai', phone: '9823456789', email: 'priya.d@gmail.com', course: 'NEET', batch: 'Afternoon', status: 'active', feeTotal: 25000, feePaid: 25000 },
        { name: 'Rohan Kulkarni', phone: '9834567890', email: 'rohan.k@gmail.com', course: '10th Board', batch: 'Morning', status: 'active', feeTotal: 5000, feePaid: 2500 },
        { name: 'Ananya Joshi', phone: '9845678901', email: 'ananya.j@gmail.com', course: 'Web Development', batch: 'Evening', status: 'active', feeTotal: 12000, feePaid: 12000 },
        { name: 'Vikram Patel', phone: '9856789012', email: 'vikram.p@gmail.com', course: 'Digital Marketing', batch: 'Weekend', status: 'active', feeTotal: 10000, feePaid: 5000 },
      ];
  ...
  clinic: {
    ...
    categories: [
      ...
      { name: 'Health Packages', icon: '❤️', color: '#e879f9', sortOrder: 5 },
    ],
    products: [
      ...
      { name: 'Specialist', price: 1000, costPrice: 0, sku: 'CON-002', stock: 999, lowStockAlert: 1, unit: 'visit', description: 'Specialist doctor consultation', catIdx: 0 },
      { name: 'Dental Checkup', price: 400, costPrice: 0, sku: 'CON-003', stock: 999, lowStockAlert: 1, unit: 'visit', description: 'Routine dental checkup', catIdx: 0 },
      { name: 'Eye Exam', price: 300, costPrice: 0, sku: 'CON-004', stock: 999, lowStockAlert: 1, unit: 'visit', description: 'Comprehensive eye examination', catIdx: 0 },
      // Lab Tests (catIdx: 1)
      { name: 'Blood Test', price: 200, costPrice: 80, sku: 'LAB-001', stock: 999, lowStockAlert: 1, unit: 'test', description: 'Complete blood count (CBC)', catIdx: 1 },
      { name: 'X-Ray', price: 400, costPrice: 180, sku: 'LAB-002', stock: 999, lowStockAlert: 1, unit: 'test', description: 'Digital X-ray imaging', catIdx: 1 },
      { name: 'MRI', price: 6000, costPrice: 3500, sku: 'LAB-003', stock: 999, lowStockAlert: 1, unit: 'test', description: 'MRI scan', catIdx: 1 },
      { name: 'Ultrasound', price: 1500, costPrice: 700, sku: 'LAB-004', stock: 999, lowStockAlert: 1, unit: 'test', description: 'Ultrasound imaging', catIdx: 1 },
      { name: 'ECG', price: 300, costPrice: 120, sku: 'LAB-005', stock: 999, lowStockAlert: 1, unit: 'test', description: 'Electrocardiogram', catIdx: 1 },
      // Pharmacy (catIdx: 2)
      { name: 'Vaccination', price: 250, costPrice: 100, sku: 'PHR-001', stock: 999, lowStockAlert: 1, unit: 'dose', description: 'Standard vaccination dose', catIdx: 2 },
      // Procedures (catIdx: 3)
      { name: 'Health Checkup', price: 3000, costPrice: 1200, sku: 'PKG-001', stock: 999, lowStockAlert: 1, unit: 'package', description: 'Comprehensive health checkup', catIdx: 3 },
      { name: 'Diabetes Package', price: 2500, costPrice: 1000, sku: 'PKG-002', stock: 999, lowStockAlert: 1, unit: 'package', description: 'Diabetes screening package', catIdx: 3 },
      { name: 'Cardiac Package', price: 5000, costPrice: 2200, sku: 'PKG-003', stock: 999, lowStockAlert: 1, unit: 'package', description: 'Cardiac health package', catIdx: 3 },
      { name: 'Women Wellness', price: 3500, costPrice: 1500, sku: 'PKG-004', stock: 999, lowStockAlert: 1, unit: 'package', description: 'Women wellness checkup package', catIdx: 3 },
      // Health Packages (catIdx: 4)
      { name: 'Physiotherapy', price: 800, costPrice: 300, sku: 'HLT-001', stock: 999, lowStockAlert: 1, unit: 'session', description: 'Physiotherapy session', catIdx: 4 },
    ],
    staff: [
    ...
    nicheSpecificSeeds: async (storeId: string) => {
      const apptDefs = [
        ...
        { customerName: 'Mohan Lal', customerPhone: '9834567890', service: 'Blood Test', staffName: 'Rajesh Naik', date: new Date(Date.now() + 30 * 60 * 1000), duration: 15, status: 'scheduled' },
        { customerName: 'Anita Sharma', customerPhone: '9845678901', service: 'Dental Checkup', staffName: 'Dr. Kavita Mehta', date: new Date(Date.now() + 3 * 60 * 60 * 1000), duration: 30, status: 'scheduled' },
        { customerName: 'Pradeep Joshi', customerPhone: '9856789012', service: 'ECG', staffName: 'Rajesh Naik', date: new Date(Date.now() + 4 * 60 * 60 * 1000), duration: 20, status: 'scheduled' },
      ];
  ...
  garage: {
    ...
    state: 'Maharashtra',
    phone: '9876543210',
    address: '56 JM Road, Shivajinagar',
    email: 'info@autofixgarage.in',
    gstNumber: '27AABCU9603R1ZT',
    taxRate: 18.0,
    receiptHeader: 'AutoFix Garage - Complete Car Care',
    receiptFooter: 'Thank you! Drive safe!',
    categories: [
      { name: 'Service & Repair', icon: '🔧', color: '#475569', sortOrder: 1 },
      { name: 'Body Work', icon: '🚗', color: '#dc2626', sortOrder: 2 },
      { name: 'Parts', icon: '⚙️', color: '#d97706', sortOrder: 3 },
      { name: 'Accessories', icon: '✨', color: '#7c3aed', sortOrder: 4 },
      { name: 'Wash & Detail', icon: '🧽', color: '#0891b2', sortOrder: 5 },
    ],
    products: [
      // Service & Repair (catIdx: 0)
      { name: 'Oil Change', price: 800, costPrice: 350, sku: 'SVC-001', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Engine oil change with filter replacement', catIdx: 0 },
      { name: 'Brake Service', price: 1500, costPrice: 600, sku: 'SVC-002', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Brake pad inspection and service', catIdx: 0 },
      { name: 'Engine Repair', price: 5000, costPrice: 2000, sku: 'SVC-003', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Engine diagnostics and repair', catIdx: 0 },
      { name: 'AC Service', price: 1200, costPrice: 450, sku: 'SVC-004', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Car AC gas refill and service', catIdx: 0 },
      { name: 'Tire Rotation', price: 400, costPrice: 150, sku: 'SVC-005', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Tire rotation and alignment check', catIdx: 0 },
      // Body Work (catIdx: 1)
      { name: 'Dent Repair', price: 2000, costPrice: 800, sku: 'BDY-001', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Paintless dent removal', catIdx: 1 },
      { name: 'Paint Touch-up', price: 3000, costPrice: 1200, sku: 'BDY-002', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Spot paint touch-up and blending', catIdx: 1 },
      { name: 'Full Body Paint', price: 15000, costPrice: 7000, sku: 'BDY-003', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Complete car body repaint', catIdx: 1 },
      // Parts (catIdx: 2)
      { name: 'Battery', price: 3000, costPrice: 1800, sku: 'PRT-001', stock: 15, lowStockAlert: 5, unit: 'piece', description: 'Car battery - 12V maintenance free', catIdx: 2 },
      { name: 'Brake Pads', price: 1200, costPrice: 600, sku: 'PRT-002', stock: 20, lowStockAlert: 5, unit: 'set', description: 'Front brake pads set', catIdx: 2 },
      { name: 'Headlight', price: 800, costPrice: 350, sku: 'PRT-003', stock: 12, lowStockAlert: 3, unit: 'piece', description: 'Halogen headlight assembly', catIdx: 2 },
      // Accessories (catIdx: 3)
      { name: 'Car Perfume', price: 250, costPrice: 80, sku: 'ACC-001', stock: 30, lowStockAlert: 5, unit: 'piece', description: 'Car air freshener - assorted', catIdx: 3 },
      { name: 'Floor Mats', price: 800, costPrice: 300, sku: 'ACC-002', stock: 15, lowStockAlert: 3, unit: 'set', description: 'Universal rubber floor mats set', catIdx: 3 },
      // Wash & Detail (catIdx: 4)
      { name: 'Basic Wash', price: 300, costPrice: 100, sku: 'WSH-001', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Exterior car wash', catIdx: 4 },
      { name: 'Detailing', price: 2000, costPrice: 800, sku: 'WSH-002', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Full interior + exterior detailing', catIdx: 4 },
    ],
    staff: [
      { name: 'Rajesh Kulkarni', phone: '9712345678', role: 'admin', shiftStart: '08:00', shiftEnd: '20:00', salary: 0, commission: 0, isActive: true },
    ...
    nicheSpecificSeeds: async (storeId: string) => {
      const vehicleDefs = [
        { ownerName: 'Rahul Verma', ownerPhone: '9812345678', make: 'Maruti', model: 'Swift', registrationNumber: 'MH12 AB 1234', year: 2022 },
        { ownerName: 'Priya Patel', ownerPhone: '9823456789', make: 'Hyundai', model: 'Creta', registrationNumber: 'MH12 CD 5678', year: 2023 },
        { ownerName: 'Amit Kumar', ownerPhone: '9834567890', make: 'Honda', model: 'City', registrationNumber: 'MH12 EF 9012', year: 2021 },
        { ownerName: 'Neha Shah', ownerPhone: '9845678901', make: 'Tata', model: 'Nexon', registrationNumber: 'MH12 GH 3456', year: 2024 },
        { ownerName: 'Suresh Reddy', ownerPhone: '9856789012', make: 'Mahindra', model: 'XUV700', registrationNumber: 'MH12 IJ 7890', year: 2023 },
      ];
  ...
  wholesale: {
    ...
    email: 'info@megatradewholesale.in',
    gstNumber: '24AABCU9603R1ZV',
    taxRate: 18.0,
    receiptHeader: 'MegaTrade Wholesale - Bulk Deals Daily',
    receiptFooter: 'Thank you for your business! Terms: 30 days credit.',
    categories: [
      { name: 'Grains & Pulses', icon: '🌾', color: '#d97706', sortOrder: 1 },
      { name: 'Spices', icon: '🌶️', color: '#dc2626', sortOrder: 2 },
      { name: 'Oils & Ghee', icon: '🫒', color: '#eab308', sortOrder: 3 },
      { name: 'Dry Fruits', icon: '🥜', color: '#7c3aed', sortOrder: 4 },
      { name: 'Household', icon: '🏠', color: '#059669', sortOrder: 5 },
    ],
    products: [
      // Grains & Pulses (catIdx: 0)
      { name: 'Rice (50kg)', price: 2200, costPrice: 1700, sku: 'GRN-001', stock: 100, lowStockAlert: 10, unit: 'bag', description: 'Basmati rice 50kg wholesale bag', catIdx: 0 },
      { name: 'Wheat (50kg)', price: 1800, costPrice: 1400, sku: 'GRN-002', stock: 120, lowStockAlert: 12, unit: 'bag', description: 'Whole wheat 50kg wholesale bag', catIdx: 0 },
      { name: 'Toor Dal (50kg)', price: 5500, costPrice: 4200, sku: 'GRN-003', stock: 60, lowStockAlert: 8, unit: 'bag', description: 'Toor dal 50kg wholesale', catIdx: 0 },
      { name: 'Chana Dal (50kg)', price: 4500, costPrice: 3500, sku: 'GRN-004', stock: 50, lowStockAlert: 8, unit: 'bag', description: 'Chana dal 50kg wholesale', catIdx: 0 },
      // Spices (catIdx: 1)
      { name: 'Turmeric (5kg)', price: 800, costPrice: 550, sku: 'SPC-001', stock: 50, lowStockAlert: 8, unit: 'pack', description: 'Turmeric powder 5kg wholesale', catIdx: 1 },
      { name: 'Red Chilli (5kg)', price: 1200, costPrice: 850, sku: 'SPC-002', stock: 40, lowStockAlert: 6, unit: 'pack', description: 'Red chilli powder 5kg wholesale', catIdx: 1 },
      { name: 'Cumin (5kg)', price: 2000, costPrice: 1400, sku: 'SPC-003', stock: 30, lowStockAlert: 5, unit: 'pack', description: 'Cumin seeds 5kg wholesale', catIdx: 1 },
      // Oils & Ghee (catIdx: 2)
      { name: 'Mustard Oil (15L)', price: 2400, costPrice: 1800, sku: 'OIL-001', stock: 40, lowStockAlert: 5, unit: 'can', description: 'Mustard oil 15L wholesale', catIdx: 2 },
      { name: 'Sunflower Oil (15L)', price: 2100, costPrice: 1600, sku: 'OIL-002', stock: 35, lowStockAlert: 5, unit: 'can', description: 'Sunflower oil 15L wholesale', catIdx: 2 },
      { name: 'Ghee (5kg)', price: 3000, costPrice: 2200, sku: 'OIL-003', stock: 25, lowStockAlert: 5, unit: 'can', description: 'Pure ghee 5kg wholesale', catIdx: 2 },
      // Dry Fruits (catIdx: 3)
      { name: 'Almond (5kg)', price: 4000, costPrice: 3000, sku: 'DRY-001', stock: 20, lowStockAlert: 4, unit: 'pack', description: 'Almonds 5kg wholesale', catIdx: 3 },
      { name: 'Cashew (5kg)', price: 6000, costPrice: 4500, sku: 'DRY-002', stock: 15, lowStockAlert: 3, unit: 'pack', description: 'Cashew nuts 5kg wholesale', catIdx: 3 },
      { name: 'Raisin (5kg)', price: 2500, costPrice: 1800, sku: 'DRY-003', stock: 25, lowStockAlert: 5, unit: 'pack', description: 'Raisins 5kg wholesale', catIdx: 3 },
      // Household (catIdx: 4)
      { name: 'Detergent (10kg)', price: 600, costPrice: 380, sku: 'HH-001', stock: 80, lowStockAlert: 10, unit: 'pack', description: 'Detergent powder 10kg wholesale', catIdx: 4 },
      { name: 'Soap Box (50pc)', price: 500, costPrice: 300, sku: 'HH-002', stock: 60, lowStockAlert: 8, unit: 'box', description: 'Bathing soap bars 50-pack', catIdx: 4 },
    ],
    staff: [
      { name: 'Suresh Agarwal', phone: '9712345678', role: 'admin', shiftStart: '07:00', shiftEnd: '21:00', salary: 0, commission: 0, isActive: true },
  ...
  jewellery: {
    ...
    state: 'Tamil Nadu',
    phone: '9876543210',
    address: '45 T Nagar, Usman Road',
    email: 'info@krishnajewellers.in',
    gstNumber: '33AABCU9603R1ZW',
    taxRate: 3.0,
    receiptHeader: 'Krishna Jewellers - Pure Gold & Diamond',
    ...
    categories: [
      ...
      { name: 'Coins & Bars', icon: '🪙', color: '#dc2626', sortOrder: 5 },
    ],
    products: [
      // Gold (catIdx: 0)
      { name: 'Gold Chain', price: 25000, costPrice: 22000, sku: 'GLD-001', stock: 15, lowStockAlert: 3, unit: 'piece', description: '22K gold chain', catIdx: 0 },
      { name: 'Gold Ring', price: 18000, costPrice: 15500, sku: 'GLD-002', stock: 20, lowStockAlert: 4, unit: 'piece', description: '22K gold ring', catIdx: 0 },
      { name: 'Gold Earrings', price: 12000, costPrice: 10200, sku: 'GLD-003', stock: 25, lowStockAlert: 5, unit: 'piece', description: '22K gold earrings', catIdx: 0 },
      { name: 'Gold Bangle', price: 35000, costPrice: 30000, sku: 'GLD-004', stock: 10, lowStockAlert: 2, unit: 'piece', description: '22K gold bangle', catIdx: 0 },
      { name: 'Gold Necklace', price: 75000, costPrice: 65000, sku: 'GLD-005', stock: 5, lowStockAlert: 2, unit: 'piece', description: '22K gold necklace', catIdx: 0 },
      // Silver (catIdx: 1)
      ...
      { name: 'Silver Ring', price: 2000, costPrice: 1300, sku: 'SLV-002', stock: 25, lowStockAlert: 5, unit: 'piece', description: 'Sterling silver ring', catIdx: 1 },
      { name: 'Silver Anklet', price: 5000, costPrice: 3300, sku: 'SLV-003', stock: 15, lowStockAlert: 3, unit: 'pair', description: 'Silver anklet pair', catIdx: 1 },
      // Diamond (catIdx: 2)
      { name: 'Diamond Ring', price: 85000, costPrice: 60000, sku: 'DIA-001', stock: 6, lowStockAlert: 2, unit: 'piece', description: 'Diamond ring in 18K gold', catIdx: 2 },
      { name: 'Diamond Earrings', price: 65000, costPrice: 45000, sku: 'DIA-002', stock: 8, lowStockAlert: 2, unit: 'piece', description: 'Diamond stud earrings in 18K gold', catIdx: 2 },
      { name: 'Diamond Pendant', price: 55000, costPrice: 38000, sku: 'DIA-003', stock: 4, lowStockAlert: 2, unit: 'piece', description: 'Diamond pendant with chain', catIdx: 2 },
      // Platinum (catIdx: 3)
      ...
      { name: 'Silver Coin', price: 800, costPrice: 550, sku: 'COIN-002', stock: 40, lowStockAlert: 8, unit: 'piece', description: 'Pure silver coin 10 grams', catIdx: 4 },
    ],
    staff: [
      { name: 'Ramesh Nair', phone: '9712345678', role: 'admin', shiftStart: '10:00', shiftEnd: '21:00', salary: 0, commission: 0, isActive: true },
  ...
  stationery: {
    ...
    state: 'Uttar Pradesh',
    phone: '9876543210',
    address: '12 Hazratganj, Aminabad',
    email: 'info@booklandstationery.in',
    gstNumber: '09AABCU9603R1ZY',
    taxRate: 18.0,
    receiptHeader: 'BookLand Stationery - Books & Office Supplies',
    ...
    categories: [
      ...
      { name: 'Pens & Pencils', icon: '🖊️', color: '#7c3aed', sortOrder: 3 },
      { name: 'Art Supplies', icon: '🎨', color: '#f97316', sortOrder: 4 },
      { name: 'Office Supplies', icon: '🏢', color: '#475569', sortOrder: 5 },
    ],
    products: [
      // Books (catIdx: 0)
      { name: 'NCERT Maths', price: 150, costPrice: 95, sku: 'BK-001', stock: 100, lowStockAlert: 15, unit: 'piece', description: 'NCERT Mathematics textbook', catIdx: 0 },
      { name: 'NCERT Science', price: 150, costPrice: 95, sku: 'BK-002', stock: 100, lowStockAlert: 15, unit: 'piece', description: 'NCERT Science textbook', catIdx: 0 },
      { name: 'English Grammar', price: 250, costPrice: 150, sku: 'BK-003', stock: 60, lowStockAlert: 10, unit: 'piece', description: 'English grammar and composition book', catIdx: 0 },
      // Notebooks (catIdx: 1)
      { name: 'Notebook (200pg)', price: 60, costPrice: 32, sku: 'NB-001', stock: 200, lowStockAlert: 30, unit: 'piece', description: 'Ruled notebook 200 pages', catIdx: 1 },
      { name: 'Notebook (100pg)', price: 35, costPrice: 18, sku: 'NB-002', stock: 250, lowStockAlert: 40, unit: 'piece', description: 'Ruled notebook 100 pages', catIdx: 1 },
      { name: 'Drawing Book', price: 80, costPrice: 42, sku: 'NB-003', stock: 80, lowStockAlert: 15, unit: 'piece', description: 'Blank drawing book A4 size', catIdx: 1 },
      // Pens & Pencils (catIdx: 2)
      { name: 'Reynolds Pen', price: 10, costPrice: 5, sku: 'PN-001', stock: 500, lowStockAlert: 50, unit: 'piece', description: 'Reynolds ballpoint pen', catIdx: 2 },
      ...
      { name: 'Pencil Set', price: 50, costPrice: 22, sku: 'PN-003', stock: 100, lowStockAlert: 20, unit: 'set', description: 'HB pencil set of 10', catIdx: 2 },
      // Art Supplies (catIdx: 3)
      { name: 'Water Colors', price: 180, costPrice: 85, sku: 'ART-001', stock: 40, lowStockAlert: 8, unit: 'box', description: 'Student watercolor kit 12 shades', catIdx: 3 },
      { name: 'Sketch Pens', price: 120, costPrice: 55, sku: 'ART-002', stock: 50, lowStockAlert: 10, unit: 'pack', description: 'Color sketch pens 12 pack', catIdx: 3 },
      { name: 'Crayons', price: 90, costPrice: 40, sku: 'ART-003', stock: 60, lowStockAlert: 10, unit: 'box', description: 'Wax crayons 24 shades', catIdx: 3 },
      // Office Supplies (catIdx: 4)
      { name: 'Chart Paper', price: 15, costPrice: 7, sku: 'OFF-001', stock: 200, lowStockAlert: 30, unit: 'piece', description: 'White chart paper A1 size', catIdx: 4 },
      { name: 'Stapler', price: 120, costPrice: 55, sku: 'OFF-002', stock: 30, lowStockAlert: 5, unit: 'piece', description: 'Office stapler with staples', catIdx: 4 },
      { name: 'File Folder', price: 30, costPrice: 14, sku: 'OFF-003', stock: 100, lowStockAlert: 15, unit: 'piece', description: 'Document file folder', catIdx: 4 },
    ],
    staff: [
  ...
  hotel: {
    storeName: 'Grand Palace Hotel',
    ownerName: 'Rajendra Singh Shekhawat',
    niche: 'hotel',
    template: 'hotel-premium',
    city: 'Jaipur',
    state: 'Rajasthan',
    phone: '9876543210',
    address: '12 MI Road, Civil Lines',
    email: 'info@grandpalacehotel.in',
    gstNumber: '08AABCU9603R1ZZ',
    taxRate: 18.0,
    receiptHeader: 'Grand Palace Hotel - Luxury Stay in Jaipur',
    receiptFooter: 'Thank you for staying with us! Namaste 🙏',
    categories: [
      { name: 'Room Service', icon: '🍽️', color: '#059669', sortOrder: 1 },
      { name: 'Dining', icon: '🍛', color: '#dc2626', sortOrder: 2 },
      { name: 'Spa & Wellness', icon: '💆', color: '#7c3aed', sortOrder: 3 },
      { name: 'Events', icon: '🎪', color: '#d97706', sortOrder: 4 },
      { name: 'Minibar', icon: '🥂', color: '#0891b2', sortOrder: 5 },
    ],
    products: [
      // Room Service (catIdx: 0)
      { name: 'Standard Room', price: 2500, costPrice: 1000, sku: 'RM-001', stock: 999, lowStockAlert: 1, unit: 'night', description: 'Standard non-AC room per night', catIdx: 0 },
      { name: 'Deluxe Room', price: 4500, costPrice: 1800, sku: 'RM-002', stock: 999, lowStockAlert: 1, unit: 'night', description: 'Deluxe AC room with city view', catIdx: 0 },
      { name: 'Suite', price: 8000, costPrice: 3500, sku: 'RM-003', stock: 999, lowStockAlert: 1, unit: 'night', description: 'Premium suite with living room', catIdx: 0 },
      // Dining (catIdx: 1)
      { name: 'Breakfast Buffet', price: 500, costPrice: 180, sku: 'DIN-001', stock: 999, lowStockAlert: 1, unit: 'person', description: 'Breakfast buffet per person', catIdx: 1 },
      { name: 'Lunch Thali', price: 350, costPrice: 130, sku: 'DIN-002', stock: 999, lowStockAlert: 1, unit: 'person', description: 'Rajasthani lunch thali', catIdx: 1 },
      { name: 'Dinner Buffet', price: 700, costPrice: 280, sku: 'DIN-003', stock: 999, lowStockAlert: 1, unit: 'person', description: 'Dinner buffet per person', catIdx: 1 },
      // Spa & Wellness (catIdx: 2)
      { name: 'Spa Massage', price: 2000, costPrice: 800, sku: 'SPA-001', stock: 999, lowStockAlert: 1, unit: 'session', description: 'Full body spa massage', catIdx: 2 },
      { name: 'Spa Facial', price: 1500, costPrice: 600, sku: 'SPA-002', stock: 999, lowStockAlert: 1, unit: 'session', description: 'Luxury facial treatment', catIdx: 2 },
      { name: 'Swimming Pool', price: 0, costPrice: 0, sku: 'SPA-003', stock: 999, lowStockAlert: 1, unit: 'access', description: 'Complimentary pool access for guests', catIdx: 2 },
      // Events (catIdx: 3)
      { name: 'Conference Room', price: 5000, costPrice: 2000, sku: 'EVT-001', stock: 999, lowStockAlert: 1, unit: 'hour', description: 'Conference room per hour', catIdx: 3 },
      { name: 'Wedding Hall', price: 50000, costPrice: 22000, sku: 'EVT-002', stock: 999, lowStockAlert: 1, unit: 'event', description: 'Wedding hall booking per event', catIdx: 3 },
      // Minibar (catIdx: 4)
      { name: 'Minibar Water', price: 100, costPrice: 30, sku: 'MIN-001', stock: 999, lowStockAlert: 1, unit: 'bottle', description: 'Premium mineral water bottle', catIdx: 4 },
      { name: 'Minibar Chips', price: 80, costPrice: 25, sku: 'MIN-002', stock: 999, lowStockAlert: 1, unit: 'pack', description: 'Assorted chips packet', catIdx: 4 },
      { name: 'Minibar Beer', price: 350, costPrice: 150, sku: 'MIN-003', stock: 999, lowStockAlert: 1, unit: 'bottle', description: 'Premium beer bottle', catIdx: 4 },
      { name: 'Laundry Service', price: 500, costPrice: 180, sku: 'MIN-004', stock: 999, lowStockAlert: 1, unit: 'service', description: 'Laundry service per load', catIdx: 4 },
    ],
    staff: [
      { name: 'Rajendra Singh Shekhawat', phone: '9712345678', role: 'admin', shiftStart: '09:00', shiftEnd: '21:00', salary: 0, commission: 0, isActive: true },
    ...
    nicheSpecificSeeds: async (storeId: string) => {
      const roomDefs = [
        { number: '101', type: 'standard', capacity: 2, status: 'available', floor: 1, pricePerNight: 2500 },
        { number: '102', type: 'standard', capacity: 2, status: 'occupied', floor: 1, pricePerNight: 2500 },
        { number: '201', type: 'deluxe', capacity: 3, status: 'available', floor: 2, pricePerNight: 4500 },
        { number: '202', type: 'deluxe', capacity: 3, status: 'occupied', floor: 2, pricePerNight: 4500 },
        { number: '301', type: 'suite', capacity: 4, status: 'available', floor: 3, pricePerNight: 8000 },
      ];
